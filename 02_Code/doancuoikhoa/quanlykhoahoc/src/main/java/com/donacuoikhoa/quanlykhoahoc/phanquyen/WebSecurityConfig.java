...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                // Phân quyền
                .antMatchers("/admin","/khoa/**","/bomon/**","/nguoidung/**","/dpnvichutri/**","/vaitrodetai/**","/capdetai/**","/detai/**","/themoidetai/**").hasAuthority("admin")
                .antMatchers("/themoidetai","themoidetai/luu").hasAnyAuthority("tham gia đề tài")
